...
const Header = (props: {
  ...
  return (
    <header className="top-0 z-999 flex w-full bg-[#E0F6FFF5] ">
      <div className="flex flex-grow items-center justify-between px-4 py-4 md:px-6 2xl:px-10">
        {/* <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          <button
            ...
            className="z-99999 block rounded-sm border border-stroke bg-white p-1.5 shadow-smlg:hidden"
          >
        ...
        {/* <div className="flex items-center justify-between gap-3 2xsm:gap-7"> */}
